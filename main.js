...
// A function that takes in a todo object and displays it on the DOM. This is a pretty big function, so we'll walk through the different parts of it.
  ...
  // }
  // todo.complete ? newTodo.classList.add('complete') : null;
  // todo.complete && newTodo.classList.add('complete');
...
// function clearTodos(){
//   const clearButton = document.querySelector('#clear-todos-button');
